  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.header}>
        <Text style={styles.title}>Welcome to CPAN213</Text>
        <Text style={styles.subtitle}>Cross-Platform Mobile Development</Text>
      </View>
      <View style={styles.content}>
        <Text style={styles.greeting}>Hello, I'm Ayobami!!</Text>
        <Text style={styles.info}>Student ID: N01675995 </Text>
        <Text style={styles.info}>Program: Computer Programming Diploma </Text>
